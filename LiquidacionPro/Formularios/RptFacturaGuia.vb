...
Public Class RptFacturaGuia
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LiquidacionPro.RptFacturaGuia.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptFacturaGuia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptFacturaGuia = New RptFacturaGuia()
        rpt.Site = Me.Site
        Return rpt
    End Function
