...
Public Class RptFacturaImpr
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LiquidacionPro.RptFacturaImpr.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptFacturaImpr
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptFacturaImpr = New RptFacturaImpr()
        rpt.Site = Me.Site
        Return rpt
    End Function
