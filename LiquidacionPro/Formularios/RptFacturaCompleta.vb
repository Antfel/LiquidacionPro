...
Public Class RptFacturaCompleta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LiquidacionPro.RptFacturaCompleta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptFacturaCompleta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptFacturaCompleta = New RptFacturaCompleta()
        rpt.Site = Me.Site
        Return rpt
    End Function
